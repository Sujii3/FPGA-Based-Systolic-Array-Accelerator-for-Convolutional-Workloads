...
The format of the weight loading scheme is as follows,

```
#col0row15[msb-lsb],col0row13[msb-lst],....,col0row1[msb-lst]#
#col0row14[msb-lsb],col0row12[msb-lst],....,col0row0[msb-lst]#
....
#col15row15[msb-lsb],col0row13[msb-lst],....,col0row1[msb-lst]#
#col15row14[msb-lsb],col0row12[msb-lst],....,col0row0[msb-lst]#
```

The current setup does all 16 output channels.