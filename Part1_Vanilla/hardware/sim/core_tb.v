...
initial begin 
  ...
  for (t=0; t<len_nij; t=t+1) begin  
    #2 clk = 1'b0;  x_scan_file = $fscanf(x_file,"%32b", D_xmem); WEN_xmem = 0; CEN_xmem = 0; if (t>0) A_xmem = A_xmem + 1;
    #2 clk = 1'b1;   
  end

  #2 clk = 1'b0;  WEN_xmem = 1;  CEN_xmem = 1; A_xmem = 0;
  #2 clk = 1'b1; 
  ...
  for (kij=0; kij<9; kij=kij+1) begin  // kij loop
    ...
    for (t=0; t<col; t=t+1) begin  
      #2 clk = 1'b0;  w_scan_file = $fscanf(w_file,"%32b", D_xmem); WEN_xmem = 0; CEN_xmem = 0; if (t>0) A_xmem = A_xmem + 1; 
      #2 clk = 1'b1;  
    end
    ...
    // TODO: confirm that oc 0 is the first line in the w_scan_file
    A_xmem = 11'b10000000000;
    ...
    #2 clk = 1'b0; l0_wr = 0; // turn off l0 writing
    #2 clk = 1'b1; 
    ...
    #2 clk = 1'b0;  load = 0;  l0_rd = 0; // turn off l0 writing
    #2 clk = 1'b1; 
    /////////////////////////////////////
    ...
    #2 clk = 1'b0;  execute = 0;  l0_rd = 0; // turn off l0 reading
    #2 clk = 1'b1; 
    /////////////////////////////////////
    ...
    #2 clk = 1'b0; WEN_pmem = 1'b1; CEN_pmem = 1'b1; A_pmem = 0; ofifo_rd = 1'b0; // turn off sram write
    #2 clk = 1'b1; 
    /////////////////////////////////////
